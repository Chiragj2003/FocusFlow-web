...
export function ExportClient() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 pt-[72px] lg:pt-0">
      {/* Header */}
      <div>
        <h1 className="text-lg sm:text-2xl lg:text-3xl font-bold text-white">Export Data</h1>
      ...
      <div className="bg-zinc-900/50 rounded-xl sm:rounded-2xl border border-zinc-800/50 p-4 sm:p-6 backdrop-blur-sm">
        <div className="flex items-start gap-3 sm:gap-4 mb-4 sm:mb-6">
          <div className="p-2.5 sm:p-3 rounded-lg sm:rounded-xl bg-red-500/10 text-red-400 shrink-0">
            <FileImage size={20} className="sm:w-6 sm:h-6" />
          </div>
          <div className="min-w-0">
            <h2 className="text-base sm:text-lg font-semibold text-white">Insights PDF Report</h2>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 sm:py-3 text-sm font-medium text-white bg-red-500 rounded-lg sm:rounded-xl hover:bg-red-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isExportingPdf ? (
            <>
            ...
            <>
              ...
              <span>Download Insights PDF</span>
            </>
          )}
        </button>
      </div>
      ...
      <div className="bg-zinc-900/50 rounded-xl sm:rounded-2xl border border-zinc-800/50 p-4 sm:p-6 backdrop-blur-sm">
        <div className="flex items-start gap-3 sm:gap-4 mb-4 sm:mb-6">
          <div className="p-2.5 sm:p-3 rounded-lg sm:rounded-xl bg-white/10 text-white shrink-0">
            <FileText size={20} className="sm:w-6 sm:h-6" />
          </div>
          <div className="min-w-0">
            <h2 className="text-base sm:text-lg font-semibold text-white">CSV Export</h2>
            <p className="text-xs sm:text-sm text-zinc-400 mt-0.5 sm:mt-1">
        ...
        <div className="mb-4 sm:mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className="px-3 py-1.5 text-xs sm:text-sm font-medium text-zinc-400 bg-zinc-800 rounded-lg hover:bg-zinc-700 transition-colors"
            >
              This Month
            </button>
            <button
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-zinc-800 border border-zinc-700 rounded-lg sm:rounded-xl focus:outline-none focus:ring-2 focus:ring-white/20 focus:border-zinc-600 text-white text-sm"
              />
            </div>
          </div>
          <div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 sm:py-3 text-sm font-medium text-zinc-900 bg-white rounded-lg sm:rounded-xl hover:bg-zinc-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isExporting ? (
            <>
              <span className="animate-spin">⏳</span>
      ...
      {/* Info */}
      <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl sm:rounded-2xl p-3 sm:p-4">
        <h3 className="text-xs sm:text-sm font-medium text-blue-400 mb-1">
          What&apos;s included in the export?
        </h3>
        <ul className="text-xs sm:text-sm text-blue-400/80 space-y-0.5 sm:space-y-1">
